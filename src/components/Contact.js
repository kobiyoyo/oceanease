...
render(){
    ...
    return(
        ...
        <div style={{ padding: '0 20px'}}><Icon type="arrow-right" /> </div> <div>Contact</div>
        </div>
        ...
        <div key="3">
        <div style={{textAlign:"center",marginTop:"50px"}}  ><h2>Send Us A Message</h2></div>
    ...
    <Button  type="primary" className='subBtn' size='large' onClick={e => this.handleFormSubmit(e)}>Send</Button>
    </div>
    </form>
