...
const Notfound = () => (
    ...
    <div class="notfound-cont text-center">
                            ...
                            <h4 className='oops'>Oops! Something Went Wrong. The Page You Are Looking Not Found.</h4>
                           <Button type='primary' size='large' ><Icon type="home" /> <NavLink to='/' style={{color:'white'}} exact={true}>Home</NavLink> </Button>
                        </div>
