...
import { Typography, Icon, Collapse } from "antd";
      ...
      <div>
        ...
        <div className="contentWrap">
          <div className="content">
            ...
            <p key="1">
              Ocean-Ease ltd provides an extensive portfolio of professional ROV
              underwater inspection and intervention services which include:
            </p>
            ...
            >
              <Panel header="Asset Integrity Inspections" key="1">
                <p>
                  • General visual inspections (GVIs) and close visual
                  inspections (CVI) using high definition cameras
                </p>
                <p>• CP Survey</p>
              ...
              <Panel header="Inspection for class" key="3">
                ...
                <p>
                  • Underwater portions of In-Service Inspection Plans (ISIP)
                </p>
              </Panel>
              ...
              <Panel
                header="Coating Condition / Marine growth assessment"
                key="10"
              >
                <p></p>
              </Panel>
              ...
              <Panel
                header="Photogrammetry, Laser Scanning and 3D modelling during inspections"
                key="12"
              >
                <p></p>
              </Panel>
